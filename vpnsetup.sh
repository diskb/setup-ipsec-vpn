...
Error: /dev/ppp is missing. LXC containers require configuration.
       See: https://github.com/diskb/setup-ipsec-vpn/issues/1014
EOF
  exit 1
  fi
}
...
get_setup_url() {
  base_url1="https://raw.githubusercontent.com/diskb/setup-ipsec-vpn/master"
  base_url2="https://gitlab.com/diskb/setup-ipsec-vpn/-/raw/master"
